...
//
//  WIRELESS TEST 
//  WILL TURN PIN 5 OF ATMEGA ON PCB TO HIGH FOR ONE SECOND IF WIRELESS IS REACHABLE A K A SETUP
//  THIS DOES NOT TEST TRANSMISSION, ONLY THE CHIP ON THE BOARD IS ALIVE
//
//
...
void sendDataToServer (unsigned int data)  {
     ...
     //       Serial.println(data);
            ...
            if (radio.setDataRate(RF24_250KBPS) == true) {
